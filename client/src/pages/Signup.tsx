...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-4">
      ...
      >
        <h2 className="text-2xl font-semibold text-blue-600 mb-1">Create account</h2>
        ...
        <select
          className="w-full mb-4 px-3 py-2 border border-slate-300 rounded focus:outline-none focus:border-blue-500 bg-white"
          value={role}
